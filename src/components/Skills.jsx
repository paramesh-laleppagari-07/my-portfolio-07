...
// ✅ Import logos properly (this ensures they build correctly)
import spyLogo from "../assets/spy.png";
import eduLogo from "../assets/edu-logo2.png";
import aimerLogo from "../assets/aimers.png";
import nptelLogo from "../assets/nptl.png";
import hackerLogo from "../assets/hacker.png";
import prepLogo from "../assets/prep-logo.jpg";
import prepMainLogo from "../assets/prep.png";
...
const certificationsData = [
  {
    ...
    logo: spyLogo,
    description:
      "Skills Covered: Python, SQL, CSS & HTML, JavaScript, ReactJS, Django basics",
    link: null,
  },
  {
    ...
    logo: eduLogo,
    description:
      "Completed a virtual internship in fullstack web development.",
  ...
  },
  {
    ...
    logo: aimerLogo,
    description:
      "Worked on AI chatbot, Power BI dashboards, video detector, vehicle detector, and traffic detector using Python.",
  ...
  },
  {
    ...
    logo: nptelLogo,
    description:
      "Completed NPTEL Cloud Computing course covering architecture, virtualization, and deployment.",
  ...
  },
  {
    ...
    logo: hackerLogo,
    description:
      "Certified in Python fundamentals including syntax, loops, and functions.",
  ...
  },
  {
    ...
    logo: hackerLogo,
    description:
      "Certified in Problem Solving (Basic) with algorithmic challenges.",
  ...
  },
  {
    ...
    logo: prepMainLogo,
    description:
      "Completed Python certification covering programming and application development.",
  ...
  },
  {
    ...
    logo: prepLogo,
    description:
      "Certified in SQL database management, queries, and relational design.",
